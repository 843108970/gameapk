...
public class FileSystemUtils {
    ...
    static {
        ...
        try {
            ...
            if (lowerCase.contains("windows")) {
                ...
                if (!lowerCase.contains("linux") && !lowerCase.contains("mpe/ix") && !lowerCase.contains("freebsd") && !lowerCase.contains("irix") && !lowerCase.contains("digital unix") && !lowerCase.contains("unix")) {
    ...
    public long freeSpaceUnix(String str, boolean z, boolean z2, long j) throws IOException {
        ...
        StringTokenizer stringTokenizer = new StringTokenizer(performCommand.get(1), s.a.f1696a);
        if (stringTokenizer.countTokens() >= 4) {
            ...
            stringTokenizer = new StringTokenizer(performCommand.get(2), s.a.f1696a);
        }
        stringTokenizer.nextToken();
        stringTokenizer.nextToken();
    ...
    public java.util.List<java.lang.String> performCommand(java.lang.String[] r11, int r12, long r13) throws java.io.IOException {
        /*
            ...
            r0.<init>(r1)
            r1 = 0
            java.lang.Thread r2 = org.apache.commons.io.ThreadMonitor.start(r13)     // Catch:{ InterruptedException -> 0x00cd, all -> 0x00c6 }
            java.lang.Process r3 = r10.openProcess(r11)     // Catch:{ InterruptedException -> 0x00cd, all -> 0x00c6 }
            java.io.InputStream r4 = r3.getInputStream()     // Catch:{ InterruptedException -> 0x00bf, all -> 0x00bc }
            java.io.OutputStream r5 = r3.getOutputStream()     // Catch:{ InterruptedException -> 0x00b9, all -> 0x00b6 }
            ...
            java.nio.charset.Charset r9 = java.nio.charset.Charset.defaultCharset()     // Catch:{ InterruptedException -> 0x00ad, all -> 0x00a9 }
            r8.<init>(r4, r9)     // Catch:{ InterruptedException -> 0x00ad, all -> 0x00a9 }
        ...
        L_0x0044:
            ...
            org.apache.commons.io.ThreadMonitor.stop(r2)     // Catch:{ InterruptedException -> 0x00a7, all -> 0x00a4 }
            int r12 = r3.exitValue()     // Catch:{ InterruptedException -> 0x00a7, all -> 0x00a4 }
            if (r12 == 0) goto L_0x0074
            java.io.IOException r12 = new java.io.IOException     // Catch:{ InterruptedException -> 0x00a7, all -> 0x00a4 }
            ...
            r0.<init>(r1)     // Catch:{ InterruptedException -> 0x00a7, all -> 0x00a4 }
            ...
            r0.append(r1)     // Catch:{ InterruptedException -> 0x00a7, all -> 0x00a4 }
            java.util.List r1 = java.util.Arrays.asList(r11)     // Catch:{ InterruptedException -> 0x00a7, all -> 0x00a4 }
            r0.append(r1)     // Catch:{ InterruptedException -> 0x00a7, all -> 0x00a4 }
            java.lang.String r0 = r0.toString()     // Catch:{ InterruptedException -> 0x00a7, all -> 0x00a4 }
            r12.<init>(r0)     // Catch:{ InterruptedException -> 0x00a7, all -> 0x00a4 }
            throw r12     // Catch:{ InterruptedException -> 0x00a7, all -> 0x00a4 }
        L_0x0074:
            boolean r12 = r0.isEmpty()     // Catch:{ InterruptedException -> 0x00a7, all -> 0x00a4 }
        ...
        L_0x00d2:
            ...
            java.util.List r11 = java.util.Arrays.asList(r11)     // Catch:{ all -> 0x00f2 }
            r2.append(r11)     // Catch:{ all -> 0x00f2 }
            java.lang.String r11 = " timeout="
            r2.append(r11)     // Catch:{ all -> 0x00f2 }
            r2.append(r13)     // Catch:{ all -> 0x00f2 }
            java.lang.String r11 = r2.toString()     // Catch:{ all -> 0x00f2 }
            r0.<init>(r11, r12)     // Catch:{ all -> 0x00f2 }
