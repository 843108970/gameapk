...
public class s {
    ...
    public static a a(char c2) {
        ...
        if (c2 < 256) {
            ...
            if (compare >= 0) {
                ...
                aVar.e = 2;
                if (i2 < 0) {
                    int length = f1693a.length - 1;
                    i3 = compare;
                    int i5 = 0;
                    while (i5 <= length) {
                        i2 = (i5 + length) / 2;
                        i3 = h.compare(ch, Character.toString(f1693a[i2]));
                        if (i3 == 0) {
                            break;
                        } else if (i3 > 0) {
                            i5 = i2 + 1;
                ...
                while (i4 < f1694b[i2].length && f1694b[i2][i4] != 0) {
                    sb.append((char) f1694b[i2][i4]);
                    i4++;
                }
                aVar.g = sb.toString();
        ...
        synchronized (s.class) {
            ...
            while (i2 < length) {
                ...
                if (!locale.equals(Locale.CHINA)) {
                    if (!locale.getLanguage().equals("zh") || !locale.getCountry().equals("HANS")) {
                        i2++;
                    }
                }
                s sVar2 = new s();
            ...
            ad.d(d, "There is no Chinese collator, HanziToPinyin is disabled");
            s sVar3 = new s();
            i = sVar3;
            return sVar3;
        }
    ...
    private ArrayList<a> a(String str) {
        ...
        if (this.f1695c && !TextUtils.isEmpty(str)) {
    ...
    public static void a(StringBuilder sb, ArrayList<a> arrayList, int i2) {
    ...
    private static boolean b() {
        ...
        for (char c3 : f1693a) {
            if (c2 != c3) {
                ...
                if (h.compare(str, ch2) >= 0) {
                    ad.b(d, "Internal error in Unihan table. The last string \"" + str + "\" is greater than current string \"" + ch2 + "\".");
                    return false;
                }
                str = ch2;
            }
