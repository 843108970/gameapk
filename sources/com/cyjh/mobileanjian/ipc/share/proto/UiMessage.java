...
public final class UiMessage {
    ...
    public static Descriptors.Descriptor f2577a;
    /* access modifiers changed from: private */

    /* renamed from: b  reason: collision with root package name */
    public static GeneratedMessage.FieldAccessorTable f2578b;
    /* access modifiers changed from: private */

    /* renamed from: c  reason: collision with root package name */
    public static Descriptors.Descriptor f2579c;
    /* access modifiers changed from: private */
    ...
    public static final class CommandToUi extends GeneratedMessage implements CommandToUiOrBuilder {
        ...
        public static Parser<CommandToUi> PARSER = new AbstractParser<CommandToUi>() {
        ...
        /* access modifiers changed from: private */
        public boolean boolParam_;
        /* access modifiers changed from: private */
        public Object color_;
        /* access modifiers changed from: private */
        public Command_Type command_;
        /* access modifiers changed from: private */
        public Object controlId_;
        /* access modifiers changed from: private */
        public boolean defaultCheckStatus_;
        /* access modifiers changed from: private */
        public int defaultItemIndex_;
        /* access modifiers changed from: private */
        public int editInputType_;
        /* access modifiers changed from: private */
        public boolean enabledStatus_;
        /* access modifiers changed from: private */
        public int fontSize_;
        /* access modifiers changed from: private */
        public Object fontType_;
        /* access modifiers changed from: private */
        public int height_;
        /* access modifiers changed from: private */
        public int intParam_;
        /* access modifiers changed from: private */
        public int itemIndex_;
        /* access modifiers changed from: private */
        public LazyStringList itemText_;
        /* access modifiers changed from: private */
        ...
        /* access modifiers changed from: private */
        public Padding_Var padding_;
        /* access modifiers changed from: private */
        public Object parentId_;
        /* access modifiers changed from: private */
        public Object path_;
        /* access modifiers changed from: private */
        public Object strParam_;
        /* access modifiers changed from: private */
        public Object text_;
        /* access modifiers changed from: private */
        public int top_;
        /* access modifiers changed from: private */
        public Object uipData_;
        private final UnknownFieldSet unknownFields;
        /* access modifiers changed from: private */
        public Object url_;
        /* access modifiers changed from: private */
        public int visibleStatus_;
        /* access modifiers changed from: private */
        public int width_;
        ...
        public static final class Builder extends GeneratedMessage.Builder<Builder> implements CommandToUiOrBuilder {
            ...
            public final CommandToUi buildPartial() {
                CommandToUi commandToUi = new CommandToUi((GeneratedMessage.Builder) this);
                int i = this.bitField0_;
                int i2 = 1;
                if ((i & 1) != 1) {
                    i2 = 0;
                }
                Command_Type unused = commandToUi.command_ = this.command_;
                if ((i & 2) == 2) {
                    i2 |= 2;
                }
                Object unused2 = commandToUi.controlId_ = this.controlId_;
                if ((i & 4) == 4) {
                    i2 |= 4;
                }
                Object unused3 = commandToUi.parentId_ = this.parentId_;
                if ((i & 8) == 8) {
                    i2 |= 8;
                }
                Object unused4 = commandToUi.text_ = this.text_;
                if ((i & 16) == 16) {
                    i2 |= 16;
                }
                int unused5 = commandToUi.width_ = this.width_;
                if ((i & 32) == 32) {
                    i2 |= 32;
                }
                int unused6 = commandToUi.height_ = this.height_;
                if ((i & 64) == 64) {
                    i2 |= 64;
                }
                int unused7 = commandToUi.layoutStyle_ = this.layoutStyle_;
                if ((i & 128) == 128) {
                    i2 |= 128;
                }
                boolean unused8 = commandToUi.defaultCheckStatus_ = this.defaultCheckStatus_;
                if ((this.bitField0_ & 256) == 256) {
                    this.itemText_ = new UnmodifiableLazyStringList(this.itemText_);
                    this.bitField0_ &= -257;
                }
                LazyStringList unused9 = commandToUi.itemText_ = this.itemText_;
                if ((i & 512) == 512) {
                    i2 |= 256;
                }
                int unused10 = commandToUi.itemIndex_ = this.itemIndex_;
                if ((i & 1024) == 1024) {
                    i2 |= 512;
                }
                int unused11 = commandToUi.defaultItemIndex_ = this.defaultItemIndex_;
                if ((i & 2048) == 2048) {
                    i2 |= 1024;
                }
                Object unused12 = commandToUi.path_ = this.path_;
                if ((i & 4096) == 4096) {
                    i2 |= 2048;
                }
                Object unused13 = commandToUi.url_ = this.url_;
                if ((i & 8192) == 8192) {
                    i2 |= 4096;
                }
                boolean unused14 = commandToUi.enabledStatus_ = this.enabledStatus_;
                if ((i & 16384) == 16384) {
                    i2 |= 8192;
                }
                int unused15 = commandToUi.visibleStatus_ = this.visibleStatus_;
                if ((32768 & i) == 32768) {
                    i2 |= 16384;
                }
                Object unused16 = commandToUi.color_ = this.color_;
                if ((65536 & i) == 65536) {
                    i2 |= 32768;
                }
                int unused17 = commandToUi.alignType_ = this.alignType_;
                if ((131072 & i) == 131072) {
                    i2 |= 65536;
                }
                Padding_Var unused18 = commandToUi.padding_ = this.paddingBuilder_ == null ? this.padding_ : this.paddingBuilder_.build();
                if ((262144 & i) == 262144) {
                    i2 |= 131072;
                }
                Object unused19 = commandToUi.uipData_ = this.uipData_;
                if ((524288 & i) == 524288) {
                    i2 |= 262144;
                }
                int unused20 = commandToUi.editInputType_ = this.editInputType_;
                if ((1048576 & i) == 1048576) {
                    i2 |= 524288;
                }
                Object unused21 = commandToUi.fontType_ = this.fontType_;
                if ((2097152 & i) == 2097152) {
                    i2 |= 1048576;
                }
                int unused22 = commandToUi.fontSize_ = this.fontSize_;
                if ((4194304 & i) == 4194304) {
                    i2 |= 2097152;
                }
                int unused23 = commandToUi.left_ = this.left_;
                if ((8388608 & i) == 8388608) {
                    i2 |= 4194304;
                }
                int unused24 = commandToUi.top_ = this.top_;
                if ((16777216 & i) == 16777216) {
                    i2 |= 8388608;
                }
                int unused25 = commandToUi.intParam_ = this.intParam_;
                if ((33554432 & i) == 33554432) {
                    i2 |= 16777216;
                }
                Object unused26 = commandToUi.strParam_ = this.strParam_;
                if ((i & 67108864) == 67108864) {
                    i2 |= 33554432;
                }
                boolean unused27 = commandToUi.boolParam_ = this.boolParam_;
                int unused28 = commandToUi.bitField0_ = i2;
                onBuilt();
                return commandToUi;
            }
            ...
            public final String getItemText(int i) {
                return (String) this.itemText_.get(i);
            }
            ...
            public final Padding_Var getPadding() {
                return this.paddingBuilder_ == null ? this.padding_ : this.paddingBuilder_.getMessage();
            }
            ...
            public final Padding_VarOrBuilder getPaddingOrBuilder() {
                return this.paddingBuilder_ != null ? this.paddingBuilder_.getMessageOrBuilder() : this.padding_;
            }
            ...
            public final GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
                return UiMessage.d.ensureFieldAccessorsInitialized(CommandToUi.class, Builder.class);
            }
            ...
            public final Builder mergeFrom(CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite) throws IOException {
                CommandToUi commandToUi;
                CommandToUi commandToUi2 = null;
                try {
                    CommandToUi parsePartialFrom = CommandToUi.PARSER.parsePartialFrom(codedInputStream, extensionRegistryLite);
                    if (parsePartialFrom != null) {
                        mergeFrom(parsePartialFrom);
                    }
                    return this;
                } catch (InvalidProtocolBufferException e) {
                    commandToUi = (CommandToUi) e.getUnfinishedMessage();
                    throw e;
                } catch (Throwable th) {
                    th = th;
                    commandToUi2 = commandToUi;
                }
                if (commandToUi2 != null) {
                    mergeFrom(commandToUi2);
                }
                throw th;
            }
            ...
            public final Builder mergePadding(Padding_Var padding_Var) {
                if (this.paddingBuilder_ == null) {
                    ...
                    this.paddingBuilder_.mergeFrom(padding_Var);
                }
                this.bitField0_ |= 131072;
                return this;
            }
            ...
            public final Builder setPadding(Padding_Var.Builder builder) {
                if (this.paddingBuilder_ == null) {
                    ...
                    this.paddingBuilder_.setMessage(builder.build());
                }
                this.bitField0_ |= 131072;
                return this;
            }
            ...
            public final Builder setPadding(Padding_Var padding_Var) {
                if (this.paddingBuilder_ != null) {
                    this.paddingBuilder_.setMessage(padding_Var);
        ...
        public enum Command_Type implements ProtocolMessageEnum {
            ...
            SET_VISIBLE(40, SET_VISIBLE_VALUE),
            ...
            SET_WINDOW_GRAVITY(63, SET_WINDOW_GRAVITY_VALUE),
            SET_CONTROL_GRAVITY(64, SET_CONTROL_GRAVITY_VALUE),
            SET_PADDING(65, SET_PADDING_VALUE),
            SET_FULLSCREEN(66, SET_FULLSCREEN_VALUE),
            ...
            CLOSE_EXIT_ACK(82, CLOSE_EXIT_ACK_VALUE);
            ...
            private static final Command_Type[] VALUES = null;
            private static Internal.EnumLiteMap<Command_Type> internalValueMap;
            private final int index;
            private final int value;

            static {
                internalValueMap = new Internal.EnumLiteMap<Command_Type>() {
            ...
            private Command_Type(int i, int i2) {
                this.index = i;
                this.value = i2;
            }
                                                ...
                                                switch (i) {
                                                    ...
                                                    default:
                                                        switch (i) {
                                                            ...
                                                            case SET_CONTROL_GRAVITY_VALUE:
                                                                return SET_CONTROL_GRAVITY;
                                                            case SET_PADDING_VALUE:
                                                                return SET_PADDING;
                                                            case SET_FULLSCREEN_VALUE:
                                                            ...
                                                            default:
                                                                switch (i) {
                                                                    ...
                                                                    default:
                                                                        switch (i) {
                                                                            case GET_UIP_DATA_VALUE:
                                                                                return GET_UIP_DATA;
                                                                            case SET_UIP_DATA_VALUE:
                                                                                return SET_UIP_DATA;
                                                                            default:
                                                                                switch (i) {
                                                                                    case CLOSE_CONTINUE_ACK_VALUE:
                                                                                        return CLOSE_CONTINUE_ACK;
                                                                                    case CLOSE_EXIT_ACK_VALUE:
                ...
                try {
                    ...
                    switch (readTag) {
                        ...
                        case 146:
                            ...
                            this.padding_ = (Padding_Var) codedInputStream.readMessage(Padding_Var.PARSER, extensionRegistryLite);
                            if (builder != null) {
                                builder.mergeFrom(this.padding_);
    ...
    public static final class CommandToUip extends GeneratedMessage implements CommandToUipOrBuilder {
        public static final int COMMAND_FIELD_NUMBER = 1;
        public static final int CONTROL_ID_FIELD_NUMBER = 2;
        public static Parser<CommandToUip> PARSER = new AbstractParser<CommandToUip>() {
        ...
        private int memoizedSerializedSize;
        /* access modifiers changed from: private */
        public Object uipAttributeData_;
        private final UnknownFieldSet unknownFields;
        ...
        public static final class Builder extends GeneratedMessage.Builder<Builder> implements CommandToUipOrBuilder {
            ...
            public final CommandToUip buildPartial() {
                CommandToUip commandToUip = new CommandToUip((GeneratedMessage.Builder) this);
                int i = this.bitField0_;
                int i2 = 1;
                if ((i & 1) != 1) {
                    i2 = 0;
                }
                Command_Type unused = commandToUip.command_ = this.command_;
                if ((i & 2) == 2) {
                    i2 |= 2;
                }
                Object unused2 = commandToUip.controlId_ = this.controlId_;
                if ((i & 4) == 4) {
                    i2 |= 4;
                }
                Object unused3 = commandToUip.uipAttributeData_ = this.uipAttributeData_;
                int unused4 = commandToUip.bitField0_ = i2;
                onBuilt();
                return commandToUip;
            }
            ...
            /* access modifiers changed from: protected */
            public final GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
                return UiMessage.l.ensureFieldAccessorsInitialized(CommandToUip.class, Builder.class);
            }
            ...
            public final Builder mergeFrom(CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite) throws IOException {
                CommandToUip commandToUip;
                CommandToUip commandToUip2 = null;
                try {
                    CommandToUip parsePartialFrom = CommandToUip.PARSER.parsePartialFrom(codedInputStream, extensionRegistryLite);
                    if (parsePartialFrom != null) {
                        mergeFrom(parsePartialFrom);
                    }
                    return this;
                } catch (InvalidProtocolBufferException e) {
                    commandToUip = (CommandToUip) e.getUnfinishedMessage();
                    throw e;
                } catch (Throwable th) {
                    th = th;
                    commandToUip2 = commandToUip;
                }
                if (commandToUip2 != null) {
                    mergeFrom(commandToUip2);
                }
                throw th;
            }
    ...
    public static final class ControlEvent extends GeneratedMessage implements ControlEventOrBuilder {
        ...
        public static Parser<ControlEvent> PARSER = new AbstractParser<ControlEvent>() {
        ...
        public Object controlId_;
        /* access modifiers changed from: private */
        public Object eventArgs_;
        /* access modifiers changed from: private */
        public Object eventFunctionName_;
        private byte memoizedIsInitialized;
        private int memoizedSerializedSize;
        /* access modifiers changed from: private */
        public Event_Type type_;
        private final UnknownFieldSet unknownFields;
        ...
        public static final class Builder extends GeneratedMessage.Builder<Builder> implements ControlEventOrBuilder {
            ...
            public final ControlEvent buildPartial() {
                ControlEvent controlEvent = new ControlEvent((GeneratedMessage.Builder) this);
                int i = this.bitField0_;
                int i2 = 1;
                if ((i & 1) != 1) {
                    i2 = 0;
                }
                Object unused = controlEvent.controlId_ = this.controlId_;
                if ((i & 2) == 2) {
                    i2 |= 2;
                }
                Event_Type unused2 = controlEvent.type_ = this.type_;
                if ((i & 4) == 4) {
                    i2 |= 4;
                }
                Object unused3 = controlEvent.eventArgs_ = this.eventArgs_;
                if ((i & 8) == 8) {
                    i2 |= 8;
                }
                Object unused4 = controlEvent.eventFunctionName_ = this.eventFunctionName_;
                int unused5 = controlEvent.bitField0_ = i2;
                onBuilt();
                return controlEvent;
            }
            ...
            /* access modifiers changed from: protected */
            public final GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
                return UiMessage.f.ensureFieldAccessorsInitialized(ControlEvent.class, Builder.class);
            }
            ...
            public final Builder mergeFrom(CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite) throws IOException {
                ...
                try {
                    ControlEvent parsePartialFrom = ControlEvent.PARSER.parsePartialFrom(codedInputStream, extensionRegistryLite);
                    if (parsePartialFrom != null) {
                        mergeFrom(parsePartialFrom);
                    }
                    return this;
                } catch (InvalidProtocolBufferException e) {
                    controlEvent = (ControlEvent) e.getUnfinishedMessage();
                    throw e;
                } catch (Throwable th) {
                    th = th;
        ...
        public enum Event_Type implements ProtocolMessageEnum {
            ...
            private static final Event_Type[] VALUES = null;
            private static Internal.EnumLiteMap<Event_Type> internalValueMap;
            private final int index;
            private final int value;

            static {
                internalValueMap = new Internal.EnumLiteMap<Event_Type>() {
            ...
            private Event_Type(int i, int i2) {
                this.index = i;
                this.value = i2;
            }
    ...
    public static final class ControlVar extends GeneratedMessage implements ControlVarOrBuilder {
        ...
        public static Parser<ControlVar> PARSER = new AbstractParser<ControlVar>() {
        ...
        public static final class Builder extends GeneratedMessage.Builder<Builder> implements ControlVarOrBuilder {
            ...
            public final ControlVar buildPartial() {
                ControlVar controlVar = new ControlVar((GeneratedMessage.Builder) this);
                int i = this.bitField0_;
                int i2 = 1;
                if ((i & 1) != 1) {
                    i2 = 0;
                }
                Object unused = controlVar.controlId_ = this.controlId_;
                if ((i & 2) == 2) {
                    i2 |= 2;
                }
                Data_Type unused2 = controlVar.type_ = this.type_;
                if ((i & 4) == 4) {
                    i2 |= 4;
                }
                boolean unused3 = controlVar.boolValue_ = this.boolValue_;
                if ((i & 8) == 8) {
                    i2 |= 8;
                }
                int unused4 = controlVar.intValue_ = this.intValue_;
                if ((i & 16) == 16) {
                    i2 |= 16;
                }
                Object unused5 = controlVar.stringValue_ = this.stringValue_;
                int unused6 = controlVar.bitField0_ = i2;
                onBuilt();
                return controlVar;
            }
            ...
            /* access modifiers changed from: protected */
            public final GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
                return UiMessage.h.ensureFieldAccessorsInitialized(ControlVar.class, Builder.class);
            }
            ...
            public final Builder mergeFrom(CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite) throws IOException {
                ...
                ControlVar controlVar2 = null;
                try {
                    ControlVar parsePartialFrom = ControlVar.PARSER.parsePartialFrom(codedInputStream, extensionRegistryLite);
                    if (parsePartialFrom != null) {
                        mergeFrom(parsePartialFrom);
                    }
                    return this;
                } catch (InvalidProtocolBufferException e) {
                    controlVar = (ControlVar) e.getUnfinishedMessage();
                    throw e;
                } catch (Throwable th) {
                    th = th;
                    controlVar2 = controlVar;
                }
                if (controlVar2 != null) {
                    mergeFrom(controlVar2);
                }
                throw th;
            }
        ...
        public enum Data_Type implements ProtocolMessageEnum {
            ...
            private static final Data_Type[] VALUES = null;
            private static Internal.EnumLiteMap<Data_Type> internalValueMap;
            private final int index;
            private final int value;

            static {
                internalValueMap = new Internal.EnumLiteMap<Data_Type>() {
            ...
            private Data_Type(int i, int i2) {
                this.index = i;
                this.value = i2;
            }
    ...
    public static final class Padding_Var extends GeneratedMessage implements Padding_VarOrBuilder {
        ...
        public static Parser<Padding_Var> PARSER = new AbstractParser<Padding_Var>() {
        ...
        public static final class Builder extends GeneratedMessage.Builder<Builder> implements Padding_VarOrBuilder {
            ...
            public final Padding_Var buildPartial() {
                Padding_Var padding_Var = new Padding_Var((GeneratedMessage.Builder) this);
                int i = this.bitField0_;
                int i2 = 1;
                if ((i & 1) != 1) {
                    i2 = 0;
                }
                int unused = padding_Var.top_ = this.top_;
                if ((i & 2) == 2) {
                    i2 |= 2;
                }
                int unused2 = padding_Var.left_ = this.left_;
                if ((i & 4) == 4) {
                    i2 |= 4;
                }
                int unused3 = padding_Var.bottom_ = this.bottom_;
                if ((i & 8) == 8) {
                    i2 |= 8;
                }
                int unused4 = padding_Var.right_ = this.right_;
                int unused5 = padding_Var.bitField0_ = i2;
                onBuilt();
                return padding_Var;
            }
            ...
            /* access modifiers changed from: protected */
            public final GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
                return UiMessage.f2578b.ensureFieldAccessorsInitialized(Padding_Var.class, Builder.class);
            }
            ...
            public final Builder mergeFrom(CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite) throws IOException {
                ...
                Padding_Var padding_Var2 = null;
                try {
                    Padding_Var parsePartialFrom = Padding_Var.PARSER.parsePartialFrom(codedInputStream, extensionRegistryLite);
                    if (parsePartialFrom != null) {
                        mergeFrom(parsePartialFrom);
                    }
                    return this;
                } catch (InvalidProtocolBufferException e) {
                    padding_Var = (Padding_Var) e.getUnfinishedMessage();
                    throw e;
                } catch (Throwable th) {
                    th = th;
                    padding_Var2 = padding_Var;
                }
                if (padding_Var2 != null) {
                    mergeFrom(padding_Var2);
                }
                throw th;
            }
    ...
    public static final class UiToCommand extends GeneratedMessage implements UiToCommandOrBuilder {
        ...
        public static Parser<UiToCommand> PARSER = new AbstractParser<UiToCommand>() {
        ...
        private final UnknownFieldSet unknownFields;
        /* access modifiers changed from: private */
        public List<ControlVar> varTable_;
        ...
        public static final class Builder extends GeneratedMessage.Builder<Builder> implements UiToCommandOrBuilder {
            ...
            public final Builder addAllVarTable(Iterable<? extends ControlVar> iterable) {
                ...
                this.varTableBuilder_.addAllMessages(iterable);
                return this;
            }
            ...
            public final Builder addVarTable(int i, ControlVar.Builder builder) {
                ...
                this.varTableBuilder_.addMessage(i, builder.build());
                return this;
            }

            public final Builder addVarTable(int i, ControlVar controlVar) {
                if (this.varTableBuilder_ != null) {
                    this.varTableBuilder_.addMessage(i, controlVar);
                    return this;
            ...
            public final Builder addVarTable(ControlVar.Builder builder) {
                ...
                this.varTableBuilder_.addMessage(builder.build());
                return this;
            }

            public final Builder addVarTable(ControlVar controlVar) {
                if (this.varTableBuilder_ != null) {
                    this.varTableBuilder_.addMessage(controlVar);
                    return this;
                } else if (controlVar == null) {
                    throw new NullPointerException();
                } else {
            ...
            public final UiToCommand buildPartial() {
                List<ControlVar> list;
                UiToCommand uiToCommand = new UiToCommand((GeneratedMessage.Builder) this);
                int i = this.bitField0_;
                int i2 = 1;
                if ((i & 1) != 1) {
                    i2 = 0;
                }
                Command_Type unused = uiToCommand.command_ = this.command_;
                if ((i & 2) == 2) {
                    i2 |= 2;
                }
                ControlEvent unused2 = uiToCommand.event_ = this.eventBuilder_ == null ? this.event_ : this.eventBuilder_.build();
                if ((i & 4) == 4) {
                    i2 |= 4;
                }
                boolean unused3 = uiToCommand.isSuccess_ = this.isSuccess_;
                if (this.varTableBuilder_ == null) {
                    if ((this.bitField0_ & 8) == 8) {
                    ...
                    list = this.varTableBuilder_.build();
                }
                List unused4 = uiToCommand.varTable_ = list;
                int unused5 = uiToCommand.bitField0_ = i2;
                onBuilt();
                return uiToCommand;
            }
            ...
            public final ControlVar getVarTable(int i) {
                return (ControlVar) (this.varTableBuilder_ == null ? this.varTable_.get(i) : this.varTableBuilder_.getMessage(i));
            }
            ...
            public final int getVarTableCount() {
                return this.varTableBuilder_ == null ? this.varTable_.size() : this.varTableBuilder_.getCount();
            }

            public final List<ControlVar> getVarTableList() {
                return this.varTableBuilder_ == null ? Collections.unmodifiableList(this.varTable_) : this.varTableBuilder_.getMessageList();
            }

            public final ControlVarOrBuilder getVarTableOrBuilder(int i) {
                return (ControlVarOrBuilder) (this.varTableBuilder_ == null ? this.varTable_.get(i) : this.varTableBuilder_.getMessageOrBuilder(i));
            }

            public final List<? extends ControlVarOrBuilder> getVarTableOrBuilderList() {
                return this.varTableBuilder_ != null ? this.varTableBuilder_.getMessageOrBuilderList() : Collections.unmodifiableList(this.varTable_);
            }
            ...
            /* access modifiers changed from: protected */
            public final GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
                return UiMessage.j.ensureFieldAccessorsInitialized(UiToCommand.class, Builder.class);
            }
            ...
            public final Builder mergeEvent(ControlEvent controlEvent) {
                if (this.eventBuilder_ == null) {
                    ...
                    this.eventBuilder_.mergeFrom(controlEvent);
                }
                this.bitField0_ |= 2;
                return this;
            }
            ...
            public final Builder mergeFrom(CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite) throws IOException {
                UiToCommand uiToCommand;
                UiToCommand uiToCommand2 = null;
                try {
                    UiToCommand parsePartialFrom = UiToCommand.PARSER.parsePartialFrom(codedInputStream, extensionRegistryLite);
                    if (parsePartialFrom != null) {
                        mergeFrom(parsePartialFrom);
                    }
                    return this;
                } catch (InvalidProtocolBufferException e) {
                    uiToCommand = (UiToCommand) e.getUnfinishedMessage();
                    throw e;
                } catch (Throwable th) {
                    th = th;
                    uiToCommand2 = uiToCommand;
                }
                if (uiToCommand2 != null) {
                    mergeFrom(uiToCommand2);
                }
                throw th;
            }
            ...
            public final Builder removeVarTable(int i) {
                ...
                this.varTableBuilder_.remove(i);
                return this;
            }
            ...
            public final Builder setEvent(ControlEvent controlEvent) {
                if (this.eventBuilder_ != null) {
                    this.eventBuilder_.setMessage(controlEvent);
            ...
            public final Builder setVarTable(int i, ControlVar.Builder builder) {
                ...
                this.varTableBuilder_.setMessage(i, builder.build());
                return this;
            }

            public final Builder setVarTable(int i, ControlVar controlVar) {
                if (this.varTableBuilder_ != null) {
                    this.varTableBuilder_.setMessage(i, controlVar);
                    return this;
                } else if (controlVar == null) {
                    throw new NullPointerException();
                } else {
    ...
    public static final class UipToCommand extends GeneratedMessage implements UipToCommandOrBuilder {
        ...
        public static final int EVENT_FIELD_NUMBER = 2;
        public static final int ISSUCCESS_FIELD_NUMBER = 3;
        public static Parser<UipToCommand> PARSER = new AbstractParser<UipToCommand>() {
        ...
        public static final class Builder extends GeneratedMessage.Builder<Builder> implements UipToCommandOrBuilder {
            ...
            public final UipToCommand buildPartial() {
                UipToCommand uipToCommand = new UipToCommand((GeneratedMessage.Builder) this);
                int i = this.bitField0_;
                int i2 = 1;
                if ((i & 1) != 1) {
                    i2 = 0;
                }
                Command_Type unused = uipToCommand.command_ = this.command_;
                if ((i & 2) == 2) {
                    i2 |= 2;
                }
                ControlEvent unused2 = uipToCommand.event_ = this.eventBuilder_ == null ? this.event_ : this.eventBuilder_.build();
                if ((i & 4) == 4) {
                    i2 |= 4;
                }
                boolean unused3 = uipToCommand.isSuccess_ = this.isSuccess_;
                if ((i & 8) == 8) {
                    i2 |= 8;
                }
                Object unused4 = uipToCommand.uipAttributeData_ = this.uipAttributeData_;
                int unused5 = uipToCommand.bitField0_ = i2;
                onBuilt();
                return uipToCommand;
            }
            ...
            /* access modifiers changed from: protected */
            public final GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
                return UiMessage.n.ensureFieldAccessorsInitialized(UipToCommand.class, Builder.class);
            }
            ...
            public final Builder mergeFrom(CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite) throws IOException {
                UipToCommand uipToCommand;
                UipToCommand uipToCommand2 = null;
                try {
                    UipToCommand parsePartialFrom = UipToCommand.PARSER.parsePartialFrom(codedInputStream, extensionRegistryLite);
                    if (parsePartialFrom != null) {
                        mergeFrom(parsePartialFrom);
                    }
                    return this;
                } catch (InvalidProtocolBufferException e) {
                    uipToCommand = (UipToCommand) e.getUnfinishedMessage();
                    throw e;
                } catch (Throwable th) {
                    th = th;
                    uipToCommand2 = uipToCommand;
                }
                if (uipToCommand2 != null) {
                    mergeFrom(uipToCommand2);
                }
                throw th;
            }
    ...
    static {
        Descriptors.FileDescriptor.internalBuildGeneratedFileFrom(new String[]{"\n\u000fUiMessage.proto\"G\n\u000bPadding_Var\u0012\u000b\n\u0003Top\u0018\u0001 \u0002(\u0005\u0012\f\n\u0004Left\u0018\u0002 \u0002(\u0005\u0012\u000e\n\u0006Bottom\u0018\u0003 \u0002(\u0005\u0012\r\n\u0005Right\u0018\u0004 \u0002(\u0005\"\u0011\n\u000bCommandToUi\u0012*\n\u0007Command\u0018\u0001 \u0002(\u000e2\u0019.CommandToUi.Command_Type\u0012\u0012\n\nControl_Id\u0018\u0002 \u0001(\t\u0012\u0011\n\tParent_Id\u0018\u0003 \u0001(\t\u0012\f\n\u0004Text\u0018\u0004 \u0001(\t\u0012\r\n\u0005Width\u0018\u0005 \u0001(\u0005\u0012\u000e\n\u0006Height\u0018\u0006 \u0001(\u0005\u0012\u0014\n\fLayout_Style\u0018\u0007 \u0001(\u0005\u0012\u001c\n\u0014Default_Check_Status\u0018\b \u0001(\b\u0012\u0011\n\tItem_Text\u0018\t \u0003(\t\u0012\u0012\n\nItem_Index\u0018\n \u0001(\u0005\u0012\u001a\n\u0012Default_Item_Index\u0018\u000b \u0001(\u0005\u0012\f\n\u0004Path\u0018\f \u0001(\t\u0012\u000b\n\u0003Url\u0018\r \u0001(\t\u0012\u0016\n\u000eEnabled_Status\u0018\u000e", " \u0001(\b\u0012\u0016\n\u000eVisible_Status\u0018\u000f \u0001(\u0005\u0012\r\n\u0005Color\u0018\u0010 \u0001(\t\u0012\u0011\n\tAlignType\u0018\u0011 \u0001(\u0005\u0012\u001d\n\u0007Padding\u0018\u0012 \u0001(\u000b2\f.Padding_Var\u0012\u0010\n\bUip_Data\u0018\u0013 \u0001(\t\u0012\u0017\n\u000fEdit_Input_Type\u0018\u0014 \u0001(\u0005\u0012\u0011\n\tFont_Type\u0018\u0015 \u0001(\t\u0012\u0011\n\tFont_Size\u0018\u0016 \u0001(\u0005\u0012\f\n\u0004Left\u0018\u0017 \u0001(\u0005\u0012\u000b\n\u0003Top\u0018\u0018 \u0001(\u0005\u0012\u0011\n\tInt_Param\u0018\u0019 \u0001(\u0005\u0012\u0011\n\tStr_Param\u0018\u001a \u0001(\t\u0012\u0012\n\nBool_Param\u0018\u001b \u0001(\b\"Ô\f\n\fCommand_Type\u0012\u000e\n\nNEW_LAYOUT\u0010\u0001\u0012\u000f\n\u000bSHOW_LAYOUT\u0010\u0002\u0012\u0010\n\fCLOSE_LAYOUT\u0010\u0003\u0012\r\n\tNEW_FLOAT\u0010\u0004\u0012\u000e\n\nSHOW_FLOAT\u0010\u0005\u0012\u000f\n\u000bCLOSE_FLOAT\u0010\u0006\u0012\u000e\n\nHIDE_FLOAT\u0010\u0007\u0012\u000b\n\u0007NEW_R", "OW\u0010d\u0012\u0011\n\rADD_TEXT_VIEW\u0010e\u0012\u0011\n\rADD_EDIT_TEXT\u0010f\u0012\u000e\n\nADD_BUTTON\u0010g\u0012\u0013\n\u000fADD_RADIO_GROUP\u0010h\u0012\u0011\n\rADD_CHECK_BOX\u0010i\u0012\u0012\n\u000eADD_IMAGE_VIEW\u0010j\u0012\u000f\n\u000bADD_SPINNER\u0010k\u0012\u0010\n\fADD_TAB_HOST\u0010l\u0012\u000b\n\u0007ADD_TAB\u0010m\u0012\u0010\n\fADD_WEB_VIEW\u0010n\u0012\f\n\bADD_LINE\u0010o\u0012\u0011\n\rADD_FW_BUTTON\u0010p\u0012\u0014\n\u0010ADD_FW_TEXT_VIEW\u0010q\u0012\u0015\n\u0011ADD_FW_IMAGE_VIEW\u0010r\u0012\u0012\n\rSET_TEXT_VIEW\u0010É\u0001\u0012\u0012\n\rSET_EDIT_TEXT\u0010Ê\u0001\u0012\u000f\n\nSET_BOTTON\u0010Ë\u0001\u0012\u0014\n\u000fSET_RADIO_GROUP\u0010Ì\u0001\u0012\u0012\n\rSET_CHECK_BOX\u0010Í\u0001\u0012\u0013\n\u000eSET_IMAGE_VIEW\u0010Î\u0001\u0012\u0010\n\u000bSET_SPINNER\u0010Ï\u0001", "\u0012\f\n\u0007SET_TAB\u0010Ð\u0001\u0012\u0011\n\fSET_WEB_VIEW\u0010Ñ\u0001\u0012\r\n\bSET_LINE\u0010Ò\u0001\u0012\u0018\n\u0013SET_EDIT_INPUT_TYPE\u0010Ó\u0001\u0012\r\n\bSET_FONT\u0010Ô\u0001\u0012\u0018\n\u0013SET_FONT_SIZE_LEVEL\u0010Õ\u0001\u0012\u0016\n\u0011SET_ROW_ALIGNMENT\u0010Ö\u0001\u0012\u0012\n\rSET_FW_BUTTON\u0010×\u0001\u0012\u0015\n\u0010SET_FW_TEXT_VIEW\u0010Ø\u0001\u0012\u0016\n\u0011SET_FW_IMAGE_VIEW\u0010Ù\u0001\u0012\u0010\n\u000bSET_ENABLED\u0010­\u0002\u0012\u0010\n\u000bSET_VISIBLE\u0010®\u0002\u0012\u0013\n\u000eSET_TITLE_TEXT\u0010¯\u0002\u0012\r\n\bSET_TEXT\u0010°\u0002\u0012\u0012\n\rSET_BACKCOLOR\u0010±\u0002\u0012\u0018\n\u0013SET_TITLE_BACKCOLOR\u0010²\u0002\u0012\u0012\n\rSET_TEXTCOLOR\u0010³\u0002\u0012\u000f\n\nSET_FW_PIC\u0010´\u0002\u0012\u000e\n\tSET_FW_BG\u0010µ\u0002\u0012\u0016\n\u0011SET_FW_TEXT_COLOR\u0010¶", "\u0002\u0012\u0015\n\u0010SET_FW_TEXT_SIZE\u0010·\u0002\u0012\u0012\n\rSET_FW_ENABLE\u0010¸\u0002\u0012\u0013\n\u000eSET_FW_VISIBLE\u0010¹\u0002\u0012\u0010\n\u000bGET_ENABLED\u0010\u0003\u0012\u0010\n\u000bGET_VISIBLE\u0010\u0003\u0012\u0013\n\u000eGET_TITLE_TEXT\u0010\u0003\u0012\r\n\bGET_TEXT\u0010\u0003\u0012\u0012\n\rGET_BACKCOLOR\u0010\u0003\u0012\u0018\n\u0013GET_TITLE_BACKCOLOR\u0010\u0003\u0012\u0012\n\rGET_TEXTCOLOR\u0010\u0003\u0012\u000e\n\tGET_VALUE\u0010\u0003\u0012\u0012\n\rGET_FW_ENABLE\u0010\u0003\u0012\u0013\n\u000eGET_FW_VISIBLE\u0010\u0003\u0012\u0016\n\u0011GET_FW_TEXT_COLOR\u0010\u0003\u0012\u0017\n\u0012SET_WINDOW_GRAVITY\u0010õ\u0003\u0012\u0018\n\u0013SET_CONTROL_GRAVITY\u0010ö\u0003\u0012\u0010\n\u000bSET_PADDING\u0010÷\u0003\u0012\u0013\n\u000eSET_FULLSCREEN\u0010ø\u0003\u0012\u0011\n\fLOAD_PROFILE\u0010Ù\u0004\u0012\u0011\n\fSAV", "E_PROFILE\u0010Ú\u0004\u0012\u0012\n\rSET_FW_SMOOTH\u0010Û\u0004\u0012\u0014\n\u000fIS_FW_TOUCHMOVE\u0010Ü\u0004\u0012\u000e\n\tFW_ZORDER\u0010Ý\u0004\u0012\u000f\n\nFW_OPACITY\u0010Þ\u0004\u0012\u0011\n\fFW_GET_VALUE\u0010ß\u0004\u0012\u0010\n\u000bFW_SET_LEFT\u0010à\u0004\u0012\u000f\n\nFW_SET_TOP\u0010á\u0004\u0012\u0011\n\fFW_SET_WIDTH\u0010â\u0004\u0012\u0012\n\rFW_SET_HEIGHT\u0010ã\u0004\u0012\u0010\n\u000bFW_SET_TEXT\u0010ä\u0004\u0012\u0011\n\fGET_UIP_DATA\u0010½\u0005\u0012\u0011\n\fSET_UIP_DATA\u0010¾\u0005\u0012\u0017\n\u0012CLOSE_CONTINUE_ACK\u0010¡\u0006\u0012\u0013\n\u000eCLOSE_EXIT_ACK\u0010¢\u0006\"¾\u0002\n\fControlEvent\u0012\u0012\n\nControl_Id\u0018\u0001 \u0002(\t\u0012&\n\u0004Type\u0018\u0002 \u0002(\u000e2\u0018.ControlEvent.Event_Type\u0012\u0012\n\nEvent_Args\u0018\u0003 \u0001(\t\u0012\u001b\n\u0013Event_Function_Na", "me\u0018\u0004 \u0001(\t\"À\u0001\n\nEvent_Type\u0012\r\n\tON_CHANGE\u0010\u0001\u0012\f\n\bON_CLICK\u0010\u0002\u0012\u000b\n\u0007ON_SHOW\u0010\u0003\u0012\u0015\n\u0011ON_CLOSE_CONTINUE\u0010\u0004\u0012\u0011\n\rON_CLOSE_EXIT\u0010\u0005\u0012\f\n\bON_TOUCH\u0010\u0006\u0012\u0011\n\rON_TOUCH_DOWN\u0010\u0007\u0012\u0011\n\rON_TOUCH_MOVE\u0010\b\u0012\u000f\n\u000bON_TOUCH_UP\u0010\t\u0012\f\n\bON_CLOSE\u0010\n\u0012\u000b\n\u0007ON_HIDE\u0010\u000b\"®\u0001\n\nControlVar\u0012\u0012\n\nControl_Id\u0018\u0001 \u0002(\t\u0012#\n\u0004Type\u0018\u0002 \u0001(\u000e2\u0015.ControlVar.Data_Type\u0012\u0012\n\nBool_Value\u0018\u0003 \u0001(\b\u0012\u0011\n\tInt_Value\u0018\u0004 \u0001(\u0005\u0012\u0014\n\fString_Value\u0018\u0005 \u0001(\t\"*\n\tData_Type\u0012\b\n\u0004BOOL\u0010\u0001\u0012\u0007\n\u0003INT\u0010\u0002\u0012\n\n\u0006STRING\u0010\u0003\"±\u0001\n\u000bUiToCommand\u0012*\n\u0007", "Command\u0018\u0001 \u0002(\u000e2\u0019.UiToCommand.Command_Type\u0012\u001c\n\u0005Event\u0018\u0002 \u0001(\u000b2\r.ControlEvent\u0012\u0011\n\tIsSuccess\u0018\u0003 \u0001(\b\u0012\u001d\n\bVarTable\u0018\u0004 \u0003(\u000b2\u000b.ControlVar\"&\n\fCommand_Type\u0012\t\n\u0005EVENT\u0010\u0001\u0012\u000b\n\u0007RSP_MSG\u0010\u0002\"©\u0001\n\fCommandToUip\u0012+\n\u0007Command\u0018\u0001 \u0002(\u000e2\u001a.CommandToUip.Command_Type\u0012\u0012\n\nControl_Id\u0018\u0002 \u0001(\t\u0012\u001a\n\u0012Uip_Attribute_Data\u0018\u0003 \u0001(\t\"<\n\fCommand_Type\u0012\u0015\n\u0011GET_UIP_ATTRIBUTE\u0010e\u0012\u0015\n\u0011SET_UIP_ATTRIBUTE\u0010f\"°\u0001\n\fUipToCommand\u0012+\n\u0007Command\u0018\u0001 \u0002(\u000e2\u001a.UipToCommand.Command_Type\u0012\u001c\n\u0005Ev", "ent\u0018\u0002 \u0001(\u000b2\r.ControlEvent\u0012\u0011\n\tIsSuccess\u0018\u0003 \u0001(\b\u0012\u001a\n\u0012Uip_Attribute_Data\u0018\u0004 \u0001(\t\"&\n\fCommand_Type\u0012\t\n\u0005EVENT\u0010\u0001\u0012\u000b\n\u0007RSP_MSG\u0010\u0002B2\n%com.cyjh.mobileanjian.ipc.share.protoB\tUiMessage"}, new Descriptors.FileDescriptor[0], new Descriptors.FileDescriptor.InternalDescriptorAssigner() {
            public final ExtensionRegistry assignDescriptors(Descriptors.FileDescriptor fileDescriptor) {
                Descriptors.FileDescriptor unused = UiMessage.o = fileDescriptor;
                Descriptors.Descriptor unused2 = UiMessage.f2577a = UiMessage.a().getMessageTypes().get(0);
                GeneratedMessage.FieldAccessorTable unused3 = UiMessage.f2578b = new GeneratedMessage.FieldAccessorTable(UiMessage.f2577a, new String[]{"Top", "Left", "Bottom", "Right"});
                Descriptors.Descriptor unused4 = UiMessage.f2579c = UiMessage.a().getMessageTypes().get(1);
                GeneratedMessage.FieldAccessorTable unused5 = UiMessage.d = new GeneratedMessage.FieldAccessorTable(UiMessage.f2579c, new String[]{"Command", "ControlId", "ParentId", "Text", "Width", "Height", "LayoutStyle", "DefaultCheckStatus", "ItemText", "ItemIndex", "DefaultItemIndex", "Path", "Url", "EnabledStatus", "VisibleStatus", "Color", "AlignType", "Padding", "UipData", "EditInputType", "FontType", "FontSize", "Left", "Top", "IntParam", "StrParam", "BoolParam"});
                Descriptors.Descriptor unused6 = UiMessage.e = UiMessage.a().getMessageTypes().get(2);
                GeneratedMessage.FieldAccessorTable unused7 = UiMessage.f = new GeneratedMessage.FieldAccessorTable(UiMessage.e, new String[]{"ControlId", "Type", "EventArgs", "EventFunctionName"});
                Descriptors.Descriptor unused8 = UiMessage.g = UiMessage.a().getMessageTypes().get(3);
                GeneratedMessage.FieldAccessorTable unused9 = UiMessage.h = new GeneratedMessage.FieldAccessorTable(UiMessage.g, new String[]{"ControlId", "Type", "BoolValue", "IntValue", "StringValue"});
                Descriptors.Descriptor unused10 = UiMessage.i = UiMessage.a().getMessageTypes().get(4);
                GeneratedMessage.FieldAccessorTable unused11 = UiMessage.j = new GeneratedMessage.FieldAccessorTable(UiMessage.i, new String[]{"Command", "Event", "IsSuccess", "VarTable"});
                Descriptors.Descriptor unused12 = UiMessage.k = UiMessage.a().getMessageTypes().get(5);
                GeneratedMessage.FieldAccessorTable unused13 = UiMessage.l = new GeneratedMessage.FieldAccessorTable(UiMessage.k, new String[]{"Command", "ControlId", "UipAttributeData"});
                Descriptors.Descriptor unused14 = UiMessage.m = UiMessage.a().getMessageTypes().get(6);
                GeneratedMessage.FieldAccessorTable unused15 = UiMessage.n = new GeneratedMessage.FieldAccessorTable(UiMessage.m, new String[]{"Command", "Event", "IsSuccess", "UipAttributeData"});
                return null;
            }
        });
    }
