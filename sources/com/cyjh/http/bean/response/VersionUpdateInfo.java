...
public class VersionUpdateInfo implements Parcelable {
    ...
    public static final Parcelable.Creator<VersionUpdateInfo> CREATOR = new Parcelable.Creator<VersionUpdateInfo>() {
        public final VersionUpdateInfo createFromParcel(Parcel parcel) {
            return new VersionUpdateInfo(parcel);
        }

        public final VersionUpdateInfo[] newArray(int i) {
    ...
    public String toString() {
        return "VersionUpdateInfo{UpdateType=" + this.UpdateType + ", AppName='" + this.AppName + '\'' + ", UpdateContent='" + this.UpdateContent + '\'' + ", UpdateUrl='" + this.UpdateUrl + '\'' + ", PackageName='" + this.PackageName + '\'' + ", PackageSize=" + this.PackageSize + ", AppUpdateTime=" + this.AppUpdateTime + ", ClientTimestamp=" + this.ClientTimestamp + ", ServerTimestamp=" + this.ServerTimestamp + ", StudioProjectKey=" + this.StudioProjectKey + ", DeviceName=" + this.DeviceName + ", InstanceDataUploadInterval=" + this.InstanceDataUploadInterval + ", UpgradeMode=" + this.UpgradeMode + ", AppVersion=" + this.AppVersion + '}';
    }
