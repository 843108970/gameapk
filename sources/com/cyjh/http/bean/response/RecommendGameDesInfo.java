...
public class RecommendGameDesInfo implements Parcelable {
    public static final Parcelable.Creator<RecommendGameDesInfo> CREATOR = new Parcelable.Creator<RecommendGameDesInfo>() {
        public final RecommendGameDesInfo createFromParcel(Parcel parcel) {
            return new RecommendGameDesInfo(parcel);
        }

        public final RecommendGameDesInfo[] newArray(int i) {
    ...
    protected RecommendGameDesInfo(Parcel parcel) {
