...
public class FengLingAdInfo implements Parcelable {
    public static final Parcelable.Creator<FengLingAdInfo> CREATOR = new Parcelable.Creator<FengLingAdInfo>() {
        public final FengLingAdInfo createFromParcel(Parcel parcel) {
            return new FengLingAdInfo(parcel);
        }

        public final FengLingAdInfo[] newArray(int i) {
    ...
    public void setImgs(Imgs imgs2) {
        this.imgs = imgs2;
    }
    ...
    public void setWebTracks(WebTracks webTracks2) {
        this.webTracks = webTracks2;
    }
