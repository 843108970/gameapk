...
public class c {
    ...
    private final byte[] f3850a = {0, 0, 0, 0, 0, 0, 0, 0};

    /* renamed from: b  reason: collision with root package name */
    private final int f3851b = 1;

    /* renamed from: c  reason: collision with root package name */
    private final int f3852c = 0;
    ...
    public static c a(Context context, String str, byte[] bArr) {
        try {
            ...
            e.a("walle", "[stateless] build envelope, e is " + e2.getMessage());
    ...
    private byte[] c() {
        return a(this.f3850a, (int) (System.currentTimeMillis() / 1000));
    }
