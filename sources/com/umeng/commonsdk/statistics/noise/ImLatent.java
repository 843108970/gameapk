...
public class ImLatent implements d {
    ...
    public static synchronized ImLatent getService(Context context2, StatTracer statTracer2) {
        ...
        synchronized (ImLatent.class) {
            if (instanse == null) {
                ...
                instanse = imLatent2;
                imLatent2.onImprintChanged(g.a(context2).b());
            }
            imLatent = instanse;
        }
        return imLatent;
    ...
    public void onImprintChanged(g.a aVar) {
        ...
        this.latentHour = ((long) intValue) * 3600000;
        int intValue2 = Integer.valueOf(aVar.a(v.at, "0")).intValue();
        if (intValue2 <= 0 || intValue2 > 1800) {
            intValue2 = 0;
        }
        if (intValue2 == 0) {
            this.latentWindow = (a.f3864a <= 0 || a.f3864a > 1800000) ? 10 : a.f3864a;
        } else {
    ...
    public boolean shouldStartLatency() {
        ...
        L_0x0013:
            ...
            monitor-enter(r0)
            boolean r2 = r8.mLatentActivite     // Catch:{ all -> 0x0063 }
        ...
        L_0x001c:
            ...
            java.lang.String r0 = com.umeng.commonsdk.statistics.idtracking.Envelope.getSignature(r0)
            java.lang.Object r3 = r8.mLatentLock
            monitor-enter(r3)
            int r1 = r8.latentWindow     // Catch:{ all -> 0x0048 }
            int r0 = com.umeng.commonsdk.statistics.common.DataHelper.random(r1, r0)     // Catch:{ all -> 0x0048 }
