...
public class ReportPolicy {
    ...
    public static class DebugPolicy extends ReportStrategy {
        ...
        public boolean shouldSendMessage(boolean z) {
            return System.currentTimeMillis() - UMEnvelopeBuild.lastSuccessfulBuildTime(c.a()) >= 15000;
        }
    }
    ...
    public static class DefconPolicy extends ReportStrategy {
        ...
        public boolean shouldSendMessage(boolean z) {
            return System.currentTimeMillis() - UMEnvelopeBuild.lastSuccessfulBuildTime(c.a()) >= this.defcon.getReqInterval();
        }
    }
    ...
    public static class ReportByInterval extends ReportStrategy {
        ...
        public boolean shouldSendMessage(boolean z) {
            return System.currentTimeMillis() - UMEnvelopeBuild.lastSuccessfulBuildTime(c.a()) >= this.mReportInterval;
        }
    }
    ...
    public static class ReportDaily extends ReportStrategy {
        ...
        public boolean shouldSendMessage(boolean z) {
            return System.currentTimeMillis() - UMEnvelopeBuild.lastSuccessfulBuildTime(c.a()) >= this.HOURS_DAY;
        }
    }
    ...
    public static class SmartPolicy extends ReportStrategy {
        ...
        public boolean shouldSendMessage(boolean z) {
            return System.currentTimeMillis() - UMEnvelopeBuild.lastSuccessfulBuildTime(c.a()) >= 10800000;
        }
    }
