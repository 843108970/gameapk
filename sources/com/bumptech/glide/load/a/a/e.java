...
final class e {
    ...
    private static final String f980a = "ThumbStreamOpener";

    /* renamed from: b  reason: collision with root package name */
    private static final a f981b = new a();
    ...
    e(List<ImageHeaderParser> list, d dVar, b bVar, ContentResolver contentResolver) {
        this(list, f981b, dVar, bVar, contentResolver);
    }
    ...
    /* JADX WARNING: Removed duplicated region for block: B:19:0x0027 A[Catch:{ all -> 0x0041 }] */
    ...
    public final int a(android.net.Uri r7) {
        /*
            r6 = this;
            r0 = 0
            ...
            com.bumptech.glide.load.b.a.b r2 = r6.e     // Catch:{ IOException | NullPointerException -> 0x0015 }
            int r0 = com.bumptech.glide.load.f.b(r0, r1, r2)     // Catch:{ IOException | NullPointerException -> 0x0015 }
        ...
        L_0x001e:
            ...
            r3 = 3
            boolean r2 = android.util.Log.isLoggable(r2, r3)     // Catch:{ all -> 0x0041 }
            ...
            java.lang.String r7 = r3.toString()     // Catch:{ all -> 0x0041 }
