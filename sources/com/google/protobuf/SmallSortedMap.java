...
class SmallSortedMap<K extends Comparable<K>, V> extends AbstractMap<K, V> {
    ...
    private class EntrySet extends AbstractSet<Map.Entry<K, V>> {
        ...
        public Iterator<Map.Entry<K, V>> iterator() {
            return new EntryIterator(SmallSortedMap.this, (EntryIterator) null);
        }
    ...
    public Set<Map.Entry<K, V>> entrySet() {
        if (this.lazyEntrySet == null) {
            this.lazyEntrySet = new EntrySet(this, (EntrySet) null);
        }
    ...
    public V put(K k, V v) {
        ...
        if (this.entryList.size() == this.maxArraySize) {
            Entry remove = this.entryList.remove(this.maxArraySize - 1);
