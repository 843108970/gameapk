...
public final class ExtensionRegistry extends ExtensionRegistryLite {
    ...
    public final void add(Descriptors.FieldDescriptor fieldDescriptor) {
        ...
        add(new ExtensionInfo(fieldDescriptor, (Message) null, (ExtensionInfo) null));
    }
    ...
    public final void add(Descriptors.FieldDescriptor fieldDescriptor, Message message) {
        ...
        add(new ExtensionInfo(fieldDescriptor, message, (ExtensionInfo) null));
    }
    ...
    public final void add(GeneratedMessage.GeneratedExtension<?, ?> generatedExtension) {
        ...
        if (generatedExtension.getDescriptor().getJavaType() != Descriptors.FieldDescriptor.JavaType.MESSAGE) {
            extensionInfo = new ExtensionInfo(generatedExtension.getDescriptor(), (Message) null, (ExtensionInfo) null);
            ...
            extensionInfo = new ExtensionInfo(generatedExtension.getDescriptor(), generatedExtension.getMessageDefaultInstance(), (ExtensionInfo) null);
        }
        add(extensionInfo);
    }
