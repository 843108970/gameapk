...
public final class j {
    ...
    private j(int i, int[] iArr, b... bVarArr) {
        ...
        this.f3309b = iArr;
        this.f = bVarArr;
        int i2 = bVarArr[0].f3313a;
        int i3 = 0;
        for (a aVar : bVarArr[0].f3314b) {
            i3 += aVar.f3311a * (aVar.f3312b + i2);
        }
        this.f3310c = i3;
    }
    ...
    private com.google.a.c.b e() {
        int a2 = a();
        com.google.a.c.b bVar = new com.google.a.c.b(a2);
        bVar.a(0, 0, 9, 9);
        int i = a2 - 8;
        bVar.a(i, 0, 8, 9);
        bVar.a(0, i, 9, 8);
        ...
        for (int i2 = 0; i2 < length; i2++) {
            int i3 = this.f3309b[i2] - 2;
            for (int i4 = 0; i4 < length; i4++) {
                if (!((i2 == 0 && (i4 == 0 || i4 == length - 1)) || (i2 == length - 1 && i4 == 0))) {
                    bVar.a(this.f3309b[i4] - 2, i3, 5, 5);
                }
            }
        }
        int i5 = a2 - 17;
    ...
    public final int a() {
        return (this.f3308a * 4) + 17;
    }

    public final b a(f fVar) {
        return this.f[fVar.ordinal()];
    }

    public final String toString() {
        return String.valueOf(this.f3308a);
    }
}
