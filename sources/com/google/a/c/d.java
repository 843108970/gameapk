...
public enum d {
    ...
    ISO8859_1((String) new int[]{1, 3}, (int) new String[]{CharsetUtils.DEFAULT_ENCODING_CHARSET}),
    ...
    Big5(28),
    GB18030((String) 29, (int) new String[]{l.f3087b, "EUC_CN", "GBK"}),
    ...
    public static d getCharacterSetECIByValue(int i) throws h {
        if (i >= 0 && i < 900) {
