...
final class m {
    ...
    final List<int[]> f3209a = new ArrayList();

    /* renamed from: b  reason: collision with root package name */
    final List<String> f3210b = new ArrayList();
    ...
    private java.lang.String a(java.lang.String r8) {
        /*
            ...
            java.util.List<int[]> r1 = r7.f3209a
            int r1 = r1.size()
            r2 = 0
        L_0x0014:
            r3 = 0
            if (r2 >= r1) goto L_0x0039
            java.util.List<int[]> r4 = r7.f3209a
        ...
        L_0x002b:
            ...
            java.util.List<java.lang.String> r8 = r7.f3210b
        ...
        L_0x0039:
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.a.g.m.a(java.lang.String):java.lang.String");
    }

    private void a(int[] iArr, String str) {
        this.f3209a.add(iArr);
        this.f3210b.add(str);
    }
    ...
    public final synchronized void a() {
        if (this.f3209a.isEmpty()) {
            ...
            a(new int[]{594}, "RO");
            a(new int[]{599}, "HU");
            a(new int[]{600, UiMessage.CommandToUi.Command_Type.LOAD_PROFILE_VALUE}, "ZA");
            a(new int[]{603}, "GH");
            a(new int[]{608}, "BH");
            a(new int[]{609}, "MU");
            a(new int[]{611}, "MA");
