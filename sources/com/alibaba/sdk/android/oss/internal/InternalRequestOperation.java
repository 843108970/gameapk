...
public class InternalRequestOperation {
    ...
    public InternalRequestOperation(Context context, final URI uri, OSSCredentialProvider oSSCredentialProvider, ClientConfiguration clientConfiguration) {
        ...
        z.a a2 = new z.a().c().b().d().a().a((HostnameVerifier) new HostnameVerifier() {
        ...
        if (clientConfiguration != null) {
            p pVar = new p();
            pVar.a(clientConfiguration.getMaxConcurrentRequest());
            a2.a((long) clientConfiguration.getConnectionTimeout(), TimeUnit.MILLISECONDS).b((long) clientConfiguration.getSocketTimeout(), TimeUnit.MILLISECONDS).c((long) clientConfiguration.getSocketTimeout(), TimeUnit.MILLISECONDS).a(pVar);
            if (!(clientConfiguration.getProxyHost() == null || clientConfiguration.getProxyPort() == 0)) {
                a2.a(new Proxy(Proxy.Type.HTTP, new InetSocketAddress(clientConfiguration.getProxyHost(), clientConfiguration.getProxyPort())));
            }
            this.maxRetryCount = clientConfiguration.getMaxErrorRetry();
        }
        this.innerClient = a2.e();
    }
    ...
    public OSSAsyncTask<ListPartsResult> listParts(ListPartsRequest listPartsRequest, OSSCompletedCallback<ListPartsRequest, ListPartsResult> oSSCompletedCallback) {
        ...
        if (partNumberMarker != null) {
            if (!OSSUtils.checkParamRange((long) partNumberMarker.intValue(), 0, false, UMAmapConfig.AMAP_CACHE_WRITE_TIME, true)) {
