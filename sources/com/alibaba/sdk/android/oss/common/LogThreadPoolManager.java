...
public class LogThreadPoolManager {
    ...
    /* access modifiers changed from: private */
    public final ThreadPoolExecutor mThreadPool = new ThreadPoolExecutor(1, 1, 5000, TimeUnit.MILLISECONDS, new ArrayBlockingQueue(SIZE_WORK_QUEUE), new ThreadFactory() {
