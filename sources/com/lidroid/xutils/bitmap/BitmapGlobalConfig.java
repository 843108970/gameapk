...
public class BitmapGlobalConfig {
    ...
    public BitmapCacheListener bitmapCacheListener;
    ...
    private void initBitmapCache() {
        new BitmapCacheManagementTask(this, (BitmapCacheManagementTask) null).execute((Params[]) new Object[]{0});
        new BitmapCacheManagementTask(this, (BitmapCacheManagementTask) null).execute((Params[]) new Object[]{1});
    }

    public void clearCache() {
        new BitmapCacheManagementTask(this, (BitmapCacheManagementTask) null).execute((Params[]) new Object[]{4});
    }

    public void clearCache(String str) {
        new BitmapCacheManagementTask(this, (BitmapCacheManagementTask) null).execute((Params[]) new Object[]{7, str});
    }

    public void clearDiskCache() {
        new BitmapCacheManagementTask(this, (BitmapCacheManagementTask) null).execute((Params[]) new Object[]{6});
    }

    public void clearDiskCache(String str) {
        new BitmapCacheManagementTask(this, (BitmapCacheManagementTask) null).execute((Params[]) new Object[]{9, str});
    }

    public void clearMemoryCache() {
        new BitmapCacheManagementTask(this, (BitmapCacheManagementTask) null).execute((Params[]) new Object[]{5});
    }

    public void clearMemoryCache(String str) {
        new BitmapCacheManagementTask(this, (BitmapCacheManagementTask) null).execute((Params[]) new Object[]{8, str});
    }

    public void closeCache() {
        new BitmapCacheManagementTask(this, (BitmapCacheManagementTask) null).execute((Params[]) new Object[]{3});
    }

    public void flushCache() {
        new BitmapCacheManagementTask(this, (BitmapCacheManagementTask) null).execute((Params[]) new Object[]{2});
    }
    ...
    public void setBitmapCacheListener(BitmapCacheListener bitmapCacheListener2) {
        this.bitmapCacheListener = bitmapCacheListener2;
    }
    ...
    public void setFileNameGenerator(FileNameGenerator fileNameGenerator2) {
        this.fileNameGenerator = fileNameGenerator2;
        if (this.bitmapCache != null) {
            this.bitmapCache.setDiskCacheFileNameGenerator(fileNameGenerator2);
        }
    }
    ...
    public void setMemCacheSizePercent(float f) {
        ...
        this.memoryCacheSize = Math.round(f * ((float) getMemoryClass()) * 1024.0f * 1024.0f);
        if (this.bitmapCache != null) {
