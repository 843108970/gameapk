...
public class OtherUtils {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:21:0x003b A[RETURN] */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static java.nio.charset.Charset getCharsetFromHttpRequest(org.apache.http.client.methods.HttpRequestBase r6) {
        /*
            r0 = 0
        ...
        L_0x003b:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.lidroid.xutils.util.OtherUtils.getCharsetFromHttpRequest(org.apache.http.client.methods.HttpRequestBase):java.nio.charset.Charset");
    }
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static java.lang.String getDiskCacheDir(android.content.Context r2, java.lang.String r3) {
        /*
        ...
        L_0x002a:
            ...
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.lidroid.xutils.util.OtherUtils.getDiskCacheDir(android.content.Context, java.lang.String):java.lang.String");
    }
    ...
    public static java.lang.String getUserAgent(android.content.Context r4) {
        /*
            ...
            java.lang.Class r1 = java.lang.Class.forName(r1)     // Catch:{ Throwable -> 0x001e }
            java.lang.String r2 = "web_user_agent"
            java.lang.reflect.Field r1 = r1.getDeclaredField(r2)     // Catch:{ Throwable -> 0x001e }
            java.lang.Object r1 = r1.get(r0)     // Catch:{ Throwable -> 0x001e }
            java.lang.Integer r1 = (java.lang.Integer) r1     // Catch:{ Throwable -> 0x001e }
            int r1 = r1.intValue()     // Catch:{ Throwable -> 0x001e }
            java.lang.String r4 = r4.getString(r1)     // Catch:{ Throwable -> 0x001e }
            goto L_0x001f
        L_0x001e:
            r4 = r0
        L_0x001f:
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static boolean isSupportRange(org.apache.http.HttpResponse r2) {
        /*
            r0 = 0
        ...
        L_0x0004:
            ...
            org.apache.http.Header r1 = r2.getFirstHeader(r1)
        ...
        L_0x0017:
            ...
            org.apache.http.Header r2 = r2.getFirstHeader(r1)
        ...
        L_0x002f:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.lidroid.xutils.util.OtherUtils.isSupportRange(org.apache.http.HttpResponse):boolean");
    }
    ...
    public static long sizeOfString(String str, String str2) throws UnsupportedEncodingException {
        ...
        while (i < length) {
            int i2 = i + 100;
            i = i2;
            j += (long) getSubString(str, i, i2 < length ? i2 : length).getBytes(str2).length;
        }
        return j;
    }
