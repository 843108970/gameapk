...
public final class i {
    ...
    static final Comparator<String> f316a = new Comparator<String>() {
    ...
    public static final i f317b = a("SSL_RSA_WITH_NULL_MD5");
    ...
    private static final Map<String, i> bk = new TreeMap(f316a);

    /* renamed from: c  reason: collision with root package name */
    public static final i f318c = a("SSL_RSA_WITH_NULL_SHA");
