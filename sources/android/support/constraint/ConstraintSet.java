...
public class ConstraintSet {
        ...
        while (it.hasNext()) {
            ...
            if (constraint2.mHelperType != -1 && constraint2.mHelperType == 1) {
                ...
                if (constraint2.mReferenceIds == null) {
                    if (constraint2.mReferenceIdString != null) {
            ...
            if (constraint2.mIsGuideline) {
                ...
                constraint2.applyTo(generateDefaultLayoutParams3);
    ...
    public void removeFromHorizontalChain(int i) {
        ...
        if (this.mConstraints.containsKey(Integer.valueOf(i))) {
            Constraint constraint = this.mConstraints.get(Integer.valueOf(i));
            int i12 = constraint.leftToRight;
            int i13 = constraint.rightToLeft;
            if (i12 == -1 && i13 == -1) {
                int i14 = constraint.startToEnd;
                int i15 = constraint.endToStart;
                if (!(i14 == -1 && i15 == -1)) {
                    if (i14 != -1 && i15 != -1) {
                        i10 = 0;
                        constraintSet2 = this;
                        constraintSet2.connect(i14, 7, i15, 6, 0);
                        i7 = 6;
                        i9 = 7;
                        i11 = i15;
                        i8 = i12;
                    ...
                    constraintSet2.connect(i11, i7, i8, i9, i10);
                }
                clear(i, 6);
                clear(i, 7);
                return;
