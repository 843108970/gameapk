...
public class ConstraintTableLayout extends ConstraintWidgetContainer {
    ...
    private void setChildrenConnections() {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            constraintAnchor.setStrength(strength);
    ...
    public String getColumnAlignmentRepresentation(int i) {
        VerticalSlice verticalSlice = this.mVerticalSlices.get(i);
        return verticalSlice.alignment == 1 ? "L" : verticalSlice.alignment == 0 ? "C" : verticalSlice.alignment == 3 ? TessBaseAPI.f : verticalSlice.alignment == 2 ? "R" : "!";
    }
