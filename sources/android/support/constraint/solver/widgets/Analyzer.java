...
public class Analyzer {
    ...
    private static int getMaxDimensionTraversal(ConstraintWidget constraintWidget, int i, boolean z, int i2) {
        ...
        int i14 = i13 + margin;
        int width2 = (i11 == 0 ? constraintWidget.getWidth() : constraintWidget.getHeight()) * i8;
        Iterator it = constraintWidget2.mListAnchors[i4].getResolutionNode().dependents.iterator();
        while (it.hasNext()) {
            i12 = Math.max(i12, getMaxDimensionTraversal(((ResolutionAnchor) ((ResolutionNode) it.next())).myAnchor.mOwner, i11, z2, i14));
        }
        int i15 = 0;
        for (Iterator it2 = constraintWidget2.mListAnchors[i7].getResolutionNode().dependents.iterator(); it2.hasNext(); it2 = it2) {
            i15 = Math.max(i15, getMaxDimensionTraversal(((ResolutionAnchor) ((ResolutionNode) it2.next())).myAnchor.mOwner, i11, z2, width2 + i14));
        }
        if (z3) {
            i12 -= i6;
            width = i15 + i5;
        } else {
            width = i15 + ((i11 == 0 ? constraintWidget.getWidth() : constraintWidget.getHeight()) * i8);
        }
        int i16 = 1;
        if (i11 == 1) {
            ...
            while (it3.hasNext()) {
                ...
                if (i8 == i16) {
                    i17 = Math.max(i17, getMaxDimensionTraversal(resolutionAnchor.myAnchor.mOwner, i11, z2, i6 + i14));
                    it3 = it4;
                } else {
                    i17 = Math.max(i17, getMaxDimensionTraversal(resolutionAnchor.myAnchor.mOwner, i11, z2, (i5 * i8) + i14));
                    it3 = it4;
                    i7 = i7;
                }
                i16 = 1;
        ...
        if (z2) {
            Optimizer.setOptimizedWidget(constraintWidget2, i11, i14);
            constraintWidget2.setFrame(i14, i19, i11);
        } else {
            constraintWidget2.mBelongingGroup.addWidgetsToSet(constraintWidget2, i11);
            constraintWidget2.setRelativePositioning(i14, i11);
        }
