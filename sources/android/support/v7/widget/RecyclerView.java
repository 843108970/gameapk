...
public class RecyclerView extends ViewGroup implements NestedScrollingChild2, ScrollingView {
    ...
    public static abstract class LayoutManager {
        ...
        public void setExactMeasureSpecsFrom(RecyclerView recyclerView) {
            setMeasureSpecs(View.MeasureSpec.makeMeasureSpec(recyclerView.getWidth(), e.e), View.MeasureSpec.makeMeasureSpec(recyclerView.getHeight(), e.e));
        }
    ...
    public final class Recycler {
        ...
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public final android.support.v7.widget.RecyclerView.ViewHolder tryGetViewHolderForPositionByDeadline(int r18, boolean r19, long r20) {
            /*
                r17 = this;
                r6 = r17
                r3 = r18
    ...
    public String exceptionLabel() {
        return s.a.f1696a + super.toString() + ", adapter:" + this.mAdapter + ", layout:" + this.mLayout + ", context:" + getContext();
    }
        ...
        if (this.mLayout.isAutoMeasureEnabled()) {
            ...
            if (!z && this.mAdapter != null) {
                ...
                if (this.mLayout.shouldMeasureTwice()) {
                    this.mLayout.setMeasureSpecs(View.MeasureSpec.makeMeasureSpec(getMeasuredWidth(), e.e), View.MeasureSpec.makeMeasureSpec(getMeasuredHeight(), e.e));
                    this.mState.mIsMeasuring = true;
                    dispatchLayoutStep2();
                    this.mLayout.setMeasuredDimensionFromChildren(i, i2);
                }
