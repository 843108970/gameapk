...
public class StaggeredGridLayoutManager extends RecyclerView.LayoutManager implements RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    private int fill(RecyclerView.Recycler recycler, LayoutState layoutState, RecyclerView.State state) {
        ...
        if (this.mLayoutState.mInfinite) {
            i = layoutState2.mLayoutDirection == 1 ? ActivityChooserView.ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED : Integer.MIN_VALUE;
        } else {
        ...
        while (layoutState.hasMore(state) && (this.mLayoutState.mInfinite || !this.mRemainingSpans.isEmpty())) {
            ...
            staggeredGridLayoutManager.layoutDecoratedWithMargins(view, i6, i5, i7, i2);
            if (layoutParams.mFullSpan) {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:85:0x0154, code lost:
        if (checkForGaps() != false) goto L_0x0158;
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private void onLayoutChildren(android.support.v7.widget.RecyclerView.Recycler r9, android.support.v7.widget.RecyclerView.State r10, boolean r11) {
        ...
        L_0x0001:
            ...
            android.support.v7.widget.StaggeredGridLayoutManager$SavedState r2 = r8.mPendingSavedState
            r3 = -1
            if (r2 != 0) goto L_0x000c
            int r2 = r8.mPendingScrollPosition
        ...
        L_0x0060:
            ...
            if (r5 > 0) goto L_0x00cd
        L_0x0070:
            boolean r5 = r1.mInvalidateOffsets
        ...
        L_0x00cd:
            ...
            android.support.v7.widget.LayoutState r2 = r8.mLayoutState
            r2.mRecycle = r0
            r8.mLaidOutInvalidFullSpan = r0
            android.support.v7.widget.OrientationHelper r2 = r8.mSecondaryOrientation
            int r2 = r2.getTotalSpace()
            r8.updateMeasureSpecs(r2)
            int r2 = r1.mPosition
            r8.updateLayoutState(r2, r10)
            boolean r2 = r1.mLayoutFromEnd
        ...
        L_0x0110:
            ...
            boolean r2 = r8.mShouldReverseLayout
