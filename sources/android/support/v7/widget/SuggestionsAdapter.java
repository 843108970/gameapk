...
class SuggestionsAdapter extends ResourceCursorAdapter implements View.OnClickListener {
    ...
    private android.graphics.drawable.Drawable getDrawable(android.net.Uri r7) {
        ...
        L_0x0026:
            android.content.Context r1 = r6.mProviderContext     // Catch:{ FileNotFoundException -> 0x007d }
    ...
    public Cursor getSearchManagerSuggestions(SearchableInfo searchableInfo, String str, int i) {
        ...
        Uri.Builder fragment = new Uri.Builder().scheme(b.W).authority(suggestAuthority).query("").fragment("");
