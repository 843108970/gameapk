...
public class AppCompatSpinner extends Spinner implements TintableBackgroundView {
    ...
    private class DropdownPopup extends ListPopupWindow {
        ...
        public void computeContentWidth() {
            ...
            if (AppCompatSpinner.this.mDropDownWidth == -2) {
                ...
                access$200 = Math.max(compatMeasureContentWidth, (width - paddingLeft) - paddingRight);
            } else {
                access$200 = AppCompatSpinner.this.mDropDownWidth == -1 ? (width - paddingLeft) - paddingRight : AppCompatSpinner.this.mDropDownWidth;
            }
            setContentWidth(access$200);
    ...
    public AppCompatSpinner(android.content.Context r8, android.util.AttributeSet r9, int r10, int r11, android.content.res.Resources.Theme r12) {
        ...
        L_0x0038:
            ...
            int[] r12 = ATTRS_ANDROID_SPINNERMODE     // Catch:{ Exception -> 0x005e, all -> 0x005b }
            android.content.res.TypedArray r12 = r8.obtainStyledAttributes(r9, r12, r10, r1)     // Catch:{ Exception -> 0x005e, all -> 0x005b }
            boolean r4 = r12.hasValue(r1)     // Catch:{ Exception -> 0x0059 }
            if (r4 == 0) goto L_0x0053
            int r4 = r12.getInt(r1, r1)     // Catch:{ Exception -> 0x0059 }
            r11 = r4
        L_0x0053:
