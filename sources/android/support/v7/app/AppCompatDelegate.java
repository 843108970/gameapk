...
public abstract class AppCompatDelegate {
    ...
    private static AppCompatDelegate create(Context context, Window window, AppCompatCallback appCompatCallback) {
        return Build.VERSION.SDK_INT >= 24 ? new AppCompatDelegateImplN(context, window, appCompatCallback) : Build.VERSION.SDK_INT >= 23 ? new AppCompatDelegateImplV23(context, window, appCompatCallback) : new AppCompatDelegateImplV14(context, window, appCompatCallback);
    }
