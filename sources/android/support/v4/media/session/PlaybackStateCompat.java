...
public final class PlaybackStateCompat implements Parcelable {
    ...
    public final Object getPlaybackState() {
        ...
        if (this.mStateObj == null && Build.VERSION.SDK_INT >= 21) {
            ...
            if (Build.VERSION.SDK_INT >= 22) {
                newInstance = PlaybackStateCompatApi22.newInstance(this.mState, this.mPosition, this.mBufferedPosition, this.mSpeed, this.mActions, this.mErrorMessage, this.mUpdateTime, arrayList2, this.mActiveItemId, this.mExtras);
            } else {
                newInstance = PlaybackStateCompatApi21.newInstance(this.mState, this.mPosition, this.mBufferedPosition, this.mSpeed, this.mActions, this.mErrorMessage, this.mUpdateTime, arrayList2, this.mActiveItemId);
            }
            this.mStateObj = newInstance;
        }
