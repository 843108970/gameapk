    ...
    public static abstract class Callback {
        ...
        private class StubApi21 implements MediaSessionCompatApi21.Callback {
            ...
            public void onCommand(java.lang.String r3, android.os.Bundle r4, android.os.ResultReceiver r5) {
                /*
                    ...
                    boolean r0 = r3.equals(r0)     // Catch:{ BadParcelableException -> 0x00e4 }
                    r1 = 0
                    if (r0 == 0) goto L_0x0035
                    android.support.v4.media.session.MediaSessionCompat$Callback r3 = android.support.v4.media.session.MediaSessionCompat.Callback.this     // Catch:{ BadParcelableException -> 0x00e4 }
                    java.lang.ref.WeakReference r3 = r3.mSessionImpl     // Catch:{ BadParcelableException -> 0x00e4 }
                    java.lang.Object r3 = r3.get()     // Catch:{ BadParcelableException -> 0x00e4 }
                    android.support.v4.media.session.MediaSessionCompat$MediaSessionImplApi21 r3 = (android.support.v4.media.session.MediaSessionCompat.MediaSessionImplApi21) r3     // Catch:{ BadParcelableException -> 0x00e4 }
                    if (r3 == 0) goto L_0x0034
                    android.os.Bundle r4 = new android.os.Bundle     // Catch:{ BadParcelableException -> 0x00e4 }
                    r4.<init>()     // Catch:{ BadParcelableException -> 0x00e4 }
                    android.support.v4.media.session.MediaSessionCompat$Token r3 = r3.getSessionToken()     // Catch:{ BadParcelableException -> 0x00e4 }
                    android.support.v4.media.session.IMediaSession r3 = r3.getExtraBinder()     // Catch:{ BadParcelableException -> 0x00e4 }
                    java.lang.String r0 = "android.support.v4.media.session.EXTRA_BINDER"
                    if (r3 != 0) goto L_0x0029
                    goto L_0x002d
                L_0x0029:
                    android.os.IBinder r1 = r3.asBinder()     // Catch:{ BadParcelableException -> 0x00e4 }
                L_0x002d:
                ...
                L_0x0035:
                    ...
                    java.lang.ClassLoader r3 = r3.getClassLoader()     // Catch:{ BadParcelableException -> 0x00e4 }
                    ...
                    android.os.Parcelable r4 = r4.getParcelable(r5)     // Catch:{ BadParcelableException -> 0x00e4 }
                    android.support.v4.media.MediaDescriptionCompat r4 = (android.support.v4.media.MediaDescriptionCompat) r4     // Catch:{ BadParcelableException -> 0x00e4 }
                ...
                L_0x0054:
                    ...
                    android.support.v4.media.session.MediaSessionCompat$Callback r3 = android.support.v4.media.session.MediaSessionCompat.Callback.this     // Catch:{ BadParcelableException -> 0x00e4 }
                    java.lang.String r5 = "android.support.v4.media.session.command.ARGUMENT_MEDIA_DESCRIPTION"
                    android.os.Parcelable r5 = r4.getParcelable(r5)     // Catch:{ BadParcelableException -> 0x00e4 }
                    android.support.v4.media.MediaDescriptionCompat r5 = (android.support.v4.media.MediaDescriptionCompat) r5     // Catch:{ BadParcelableException -> 0x00e4 }
                    java.lang.String r0 = "android.support.v4.media.session.command.ARGUMENT_INDEX"
                    int r4 = r4.getInt(r0)     // Catch:{ BadParcelableException -> 0x00e4 }
                ...
                L_0x0098:
                    ...
                    java.util.List r5 = r3.mQueue     // Catch:{ BadParcelableException -> 0x00e4 }
                    if (r5 == 0) goto L_0x00dd
                    java.lang.String r5 = "android.support.v4.media.session.command.ARGUMENT_INDEX"
                    r0 = -1
                    int r4 = r4.getInt(r5, r0)     // Catch:{ BadParcelableException -> 0x00e4 }
                    if (r4 < 0) goto L_0x00d2
                    java.util.List r5 = r3.mQueue     // Catch:{ BadParcelableException -> 0x00e4 }
                    int r5 = r5.size()     // Catch:{ BadParcelableException -> 0x00e4 }
                    if (r4 >= r5) goto L_0x00d2
                    java.util.List r3 = r3.mQueue     // Catch:{ BadParcelableException -> 0x00e4 }
                    java.lang.Object r3 = r3.get(r4)     // Catch:{ BadParcelableException -> 0x00e4 }
                    r1 = r3
                    android.support.v4.media.session.MediaSessionCompat$QueueItem r1 = (android.support.v4.media.session.MediaSessionCompat.QueueItem) r1     // Catch:{ BadParcelableException -> 0x00e4 }
                L_0x00d2:
                    if (r1 == 0) goto L_0x00dd
                    android.support.v4.media.session.MediaSessionCompat$Callback r3 = android.support.v4.media.session.MediaSessionCompat.Callback.this     // Catch:{ BadParcelableException -> 0x00e4 }
                    android.support.v4.media.MediaDescriptionCompat r4 = r1.getDescription()     // Catch:{ BadParcelableException -> 0x00e4 }
                    r3.onRemoveQueueItem(r4)     // Catch:{ BadParcelableException -> 0x00e4 }
                L_0x00dd:
                    return
                L_0x00de:
                    android.support.v4.media.session.MediaSessionCompat$Callback r0 = android.support.v4.media.session.MediaSessionCompat.Callback.this     // Catch:{ BadParcelableException -> 0x00e4 }
        ...
        public Callback() {
            ...
            if (Build.VERSION.SDK_INT >= 24) {
                createCallback = MediaSessionCompatApi24.createCallback(new StubApi24());
            } else if (Build.VERSION.SDK_INT >= 23) {
                createCallback = MediaSessionCompatApi23.createCallback(new StubApi23());
            } else if (Build.VERSION.SDK_INT >= 21) {
                createCallback = MediaSessionCompatApi21.createCallback(new StubApi21());
            } else {
