...
public class ViewPager extends ViewGroup {
            ...
            if (childAt2.getVisibility() != 8) {
                ...
                if (!layoutParams2.isDecor && (infoForChild = infoForChild(childAt2)) != null) {
                    ...
                    if (layoutParams2.needsMeasure) {
                        ...
                        childAt2.measure(View.MeasureSpec.makeMeasureSpec((int) (f * layoutParams2.widthFactor), e.e), View.MeasureSpec.makeMeasureSpec((i8 - i11) - i9, e.e));
                    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:29:0x00bb, code lost:
        if (r8.position == r0.mCurItem) goto L_0x00c2;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:89:0x0198, code lost:
        if (r4 < r0.mItems.size()) goto L_0x019a;
     */
