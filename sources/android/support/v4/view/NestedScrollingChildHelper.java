...
public class NestedScrollingChildHelper {
    ...
    public boolean dispatchNestedScroll(int r15, int r16, int r17, int r18, @android.support.annotation.Nullable int[] r19, int r20) {
        ...
        L_0x0053:
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.v4.view.NestedScrollingChildHelper.dispatchNestedScroll(int, int, int, int, int[], int):boolean");
    }
