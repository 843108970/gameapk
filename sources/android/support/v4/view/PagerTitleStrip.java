...
public class PagerTitleStrip extends ViewGroup {
    ...
    public void updateTextPositions(int i, float f, boolean z) {
        ...
        if (i16 == 16) {
            ...
            i2 = i13 + paddingTop;
            i3 = paddingTop + i14;
            this.mCurrText.layout(i10, i2, i11, this.mCurrText.getMeasuredHeight() + i2);
        ...
        this.mPrevText.layout(min2, i4, measuredWidth + min2, this.mPrevText.getMeasuredHeight() + i4);
        int max32 = Math.max((width - paddingRight) - i15, i11 + this.mScaledTextSpacing);
        this.mNextText.layout(max32, i3, max32 + i15, this.mNextText.getMeasuredHeight() + i3);
        this.mLastKnownPositionOffset = f;
        this.mUpdatingPositions = false;
    }
}
