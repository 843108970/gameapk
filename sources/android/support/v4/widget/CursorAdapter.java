...
public abstract class CursorAdapter extends BaseAdapter implements CursorFilter.CursorFilterClient, Filterable {
    ...
    public void init(Context context, Cursor cursor, int i) {
        ...
        this.mRowIDColumn = z ? cursor.getColumnIndexOrThrow(TrayContract.Preferences.Columns.ID) : -1;
        if ((i & 2) == 2) {
    ...
    public Cursor swapCursor(Cursor cursor) {
        ...
        if (cursor != null) {
            ...
            this.mRowIDColumn = cursor.getColumnIndexOrThrow(TrayContract.Preferences.Columns.ID);
