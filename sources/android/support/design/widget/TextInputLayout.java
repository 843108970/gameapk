...
public class TextInputLayout extends LinearLayout implements WithHint {
    ...
    public TextInputLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        if (obtainStyledAttributes.hasValue(R.styleable.TextInputLayout_passwordToggleTintMode)) {
            ...
            this.mPasswordToggleTintMode = ViewUtils.parseTintMode(obtainStyledAttributes.getInt(R.styleable.TextInputLayout_passwordToggleTintMode, -1), (PorterDuff.Mode) null);
        }
    ...
    private void setError(@Nullable final CharSequence charSequence, boolean z) {
        ...
        if (this.mErrorShown) {
            ...
            if (z) {
                ...
                listener = this.mErrorView.animate().alpha(1.0f).setDuration(200).setInterpolator(AnimationUtils.LINEAR_OUT_SLOW_IN_INTERPOLATOR).setListener(new AnimatorListenerAdapter() {
            ...
            if (this.mErrorView.getVisibility() == 0) {
                if (z) {
                    listener = this.mErrorView.animate().alpha(0.0f).setDuration(200).setInterpolator(AnimationUtils.FAST_OUT_LINEAR_IN_INTERPOLATOR).setListener(new AnimatorListenerAdapter() {
    ...
    public void updateLabelState(boolean r7, boolean r8) {
        ...
        L_0x0018:
            ...
            android.content.res.ColorStateList r5 = r6.mDefaultTextColor
