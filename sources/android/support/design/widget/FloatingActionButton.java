...
public class FloatingActionButton extends VisibilityAwareImageButton {
    ...
    public FloatingActionButton(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mBackgroundTintMode = ViewUtils.parseTintMode(obtainStyledAttributes.getInt(R.styleable.FloatingActionButton_backgroundTintMode, -1), (PorterDuff.Mode) null);
