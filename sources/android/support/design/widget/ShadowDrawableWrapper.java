...
class ShadowDrawableWrapper extends DrawableWrapper {
    ...
    private void buildShadowCorners() {
        ...
        if (f > 0.0f) {
            ...
            float[] fArr = {0.0f, f2, ((1.0f - f2) / 2.0f) + f2, 1.0f};
            RadialGradient radialGradient2 = new RadialGradient(0.0f, 0.0f, f, new int[]{0, this.mShadowStartColor, this.mShadowMiddleColor, this.mShadowEndColor}, fArr, Shader.TileMode.CLAMP);
            paint.setShader(radialGradient);
        }
        Paint paint2 = this.mEdgeShadowPaint;
        float f3 = rectF.top;
        float f4 = rectF2.top;
        int[] iArr = {this.mShadowStartColor, this.mShadowMiddleColor, this.mShadowEndColor};
