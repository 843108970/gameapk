...
public abstract class BaseAd {
    ...
    protected String feedAdId;
    protected boolean hasFeedAd;
    protected boolean hasInteractiveAd;
    protected boolean hasInterstitialAd;
    protected boolean hasInterstitialImageAd;
    protected boolean hasRewardAd;
    protected String interactiveId;
    protected String interstitialId;
    protected String interstitialImageId;
    ...
    public BaseAd(String str, Map<String, String> map) {
        this(str, (String) null, (String) null, (String) null, (String) null, (String) null, (String) null);
    }
